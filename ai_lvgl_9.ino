...
lv_chart_series_t *ui_graph_series_1 = NULL;
...
void setup() {
  ...
  // lv_obj_add_event_cb(ui_plus, plus_button, LV_EVENT_PRESSING, NULL);
  // lv_obj_add_event_cb(ui_minus, minus_button, LV_EVENT_PRESSING, NULL);
